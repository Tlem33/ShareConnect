:: ShareConnect.cmd - Créer par Tlem le 12/04/2014
:: Connecte un ou plusieurs partage sur différents lecteurs réseau.
:: Le Fichier ShareConnect.ini doit contenir les paramètres du
:: programme ainsi que les paramètres de connexion. Lancez Setup.cmd
:: pour générer un fichier .ini modèle.
::
