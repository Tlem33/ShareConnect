:: SimpleShareConnect.cmd - Créer par Tlem le 12/04/2014
:: Connecte un partage sur un lecteur réseau.
:: Les variables Drive et Share doivent être complètées.
:: Si le batch est lancé avec un paramètre, la temporisation des messages sera désactivée.
::
:: Version du 06/09/2018
